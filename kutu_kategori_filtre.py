# -*- coding: utf-8 -*-
"""Kutu_Kategori_Filtre.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/18Np3Swfu_Q3kmhwDNP3y6UOJXDHCm3dq
"""
...
def build_data():
    ...
    for fname in DATA_FILES:
        ...
        if headers is None:
            print('  WARNING: {} has no Kutu/Kategori columns, skipping.'.format(fname))
            continue
